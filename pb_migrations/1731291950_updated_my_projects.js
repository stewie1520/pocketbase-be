...
migrate((db) => {
  ...
  collection.name = "view_my_projects"
  ...
  // remove
  collection.schema.removeField("arkeqrs3")

  // remove
  collection.schema.removeField("fv08wdux")

  // remove
  collection.schema.removeField("78mflfnt")

  // remove
  collection.schema.removeField("as9o9wq6")

  // remove
  collection.schema.removeField("w5leyyl8")

  // remove
  collection.schema.removeField("clutzvuy")

  // remove
  collection.schema.removeField("mjelqwsd")

  // remove
  collection.schema.removeField("7moxsvrl")
